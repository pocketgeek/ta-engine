...
// by CMake -- project(ta-engine VERSION x.y.z) sets PROJECT_VERSION, which the
// build passes down as the TA_VERSION macro. The fallback keeps non-CMake/tool
// builds compiling.
//
...
#if defined(TA_HAVE_BUILD_ID_H)
#include "ta_build_id.h"   // generated per build; see cmake/BuildId.cmake
#endif
#ifndef TA_BUILD_ID
#define TA_BUILD_ID "unknown"
#endif

namespace ta {
inline constexpr const char* kVersion = TA_VERSION;
inline constexpr const char* kBuildId = TA_BUILD_ID;
}
